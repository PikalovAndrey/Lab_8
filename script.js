...
Department.prototype.giveSalary = function() {
 ...
 function main() {
	const dev = new Developer("Kortenaer", "Kitsuragi", 1000, 5);
  	const dev2 = new Developer("Goracy", "Kim", 1000, 1);
 	 const dev3 = new Developer("Kubek", "Rene", 1200, 9);
 	 const dev4 = new Developer("Harrier", "Du Bois", 1100, 9);
  const des = new Designer("Raul", "Week", 1200, 6, 0.5);
  const des1 = new Designer("Elvis", "Kortenaer", 1000, 6, 0.7);
  const manager = new Manager("John", "Aronoux", 1400, 5, [dev, dev2, dev3, dev4,des,des1]);
